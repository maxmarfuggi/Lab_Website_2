...
*/
	function loadStatsPage(){
		...
		for (var i = 2; i <= 13; i++){
			var oppScore;
			var oppName = document.getElementById("stats_table").rows[i].cells[1].innerHTML;
		...
		document.getElementById("losses").innerHTML = cuLose;
...
*/		
		...
		function loadPlayersPage(){
			...
			for(i = 0; i < len; i++){
				...
				let playerid = i;
				anchorTag.setAttribute('id', playerid);
				anchorTag.onclick = function(){switchPlayers(playerid)};
				anchorTag.innerHTML = players[i].name + "<br />";
